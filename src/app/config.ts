...
export class Config {
    ...
    constructor() {
        ...
        this.url = 'https://delbarrio.ec/'
        this.consumerKey = 'ck_9eee16713f333d0dbcc21dde5c6917a30b33a38b'
        this.consumerSecret = 'cs_057c81a0e7d7f07578a41a98cfaae0ba4da5cd01'
